...
type Schedule struct {
	...
	UpgrWatcherY0 string //  7 - Upgrade CI-Watcher for v. 4.y
	UpgrWatcherY1 string //  8 - Upgrade CI-Watcher for v. 4.y-1
	UpgrWatcherY2 string //  9 - Upgrade CI-Watcher for v. 4.y-2
	UpgrWatcherY3 string // 10 - Upgrade CI-Watcher for v. 4.y-3
	UpgrWatcherY4 string // 11 - Upgrade CI-Watcher for v. 4.y-4
}

func New(date interface{}, manager interface{}, e2eWatcherY0 interface{},
	e2eWatcherY1 interface{}, e2eWatcherY2 interface{}, e2eWatcherY3 interface{},
	e2eWatcherY4 interface{}, upgradeWatcherY0 interface{},
	upgradeWatcherY1 interface{}, upgradeWatcherY2 interface{},
	upgradeWatcherY3 interface{}, upgradeWatcherY4 interface{}) Schedule {
